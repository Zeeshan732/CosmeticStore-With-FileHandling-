...
class Store {
    ...
    // Method to save the inventory to the Downloads folder
    public void saveInventoryToFile(String filename) {
        String downloadsPath = "D:\\Users\\TECHNIFI\\Desktop\\products.txt";
    ...
    // Method to load the inventory from the Downloads folder
